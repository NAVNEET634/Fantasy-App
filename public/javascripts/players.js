...
$('#leagueid').change(() => {
    ...
    fillDropDown('team', filteredData, 'Choose Team', 0)
...
$.getJSON(`/teams/show`, data => {
    teams = data
    console.log('leagues',data)
    fillDropDown('team', [], 'Choose Team', 0)
        ...
        <div class="table-responsive">
          <table class="table align-items-center table-dark table-flush">
           ...
           <th scope="row">
                    ...
                    <div class="media align-items-center">
                      <div class="media-body">
                        <span class="mb-0 text-sm">${item.credit}</span>
                      </div>
                    </div>
                  </th>
...
$('#pleagueid').change(() => {
    ...
    fillDropDown('pteamid', filteredData, 'Choose Team', 0)
...
$('#result').on('click', '.edit', function() {
    ...
    $('#pteamid').append($('<option>').val(result.teamid).text(result.teamname))
   ...
   $('#pteamid').val(result.teamid)
   $('#pcredit').val(result.credit)
