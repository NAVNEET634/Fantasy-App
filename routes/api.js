...
router.post('/completed-match', (req, res) => {
    ...
    (select m.date from matches m where m.id = j.matchid) as  matchdate,
    (select l.name from leauges l where l.id = j.leagueid) as leaguename
    from join_contests j where j.number = '${req.body.number}' and (select m.status from matches m where m.id=j.matchid) = 'completed' OR j.number = '${req.body.number}' and (select m.status from matches m where m.id=j.matchid) = 'abonded' order by matchdate desc limit 20;`, (err, result) => {
        if (err) throw err;
        else res.json(result)
    })
})
...
router.post('/get-team-players', (req, res) => {
    ...
    from players p where  p.teamid = '${req.body.team1id}' OR
...
// from players p where p.type = 'Wicket Keeper' and p.teamid = '1' OR
//    p.type = 'Wicket Keeper' and p.teamid = '2'


router.post('/get-selected-players', (req, res) => {
    pool.query(`select p.* , (select t.short_name from teams t where t.id = p.teamid) as teamname from players p where p.id = '${req.body.player1}' OR p.id = '${req.body.player2}'
    OR p.id = '${req.body.player3}' OR p.id = '${req.body.player4}' OR p.id = '${req.body.player5}' OR p.id = '${req.body.player6}' OR p.id = '${req.body.player7}'
    OR p.id = '${req.body.player8}' OR p.id = '${req.body.player9}' OR p.id = '${req.body.player10}' OR p.id = '${req.body.player11}'`, (err, result) => {
        if (err) throw err;
        else res.json(result)
    })
})
...
router.post('/get-single-team', (req, res) => {
    ...
    id =(select player1 from myteams where id = '${req.body.id}') OR
    id =(select player2 from myteams where id = '${req.body.id}') OR
    id =(select player3 from myteams where id = '${req.body.id}') OR
    id =(select player4 from myteams where id = '${req.body.id}') OR
    id =(select player5 from myteams where id = '${req.body.id}') OR
    id =(select player6 from myteams where id = '${req.body.id}') OR
    id =(select player7 from myteams where id = '${req.body.id}') OR
    id =(select player8 from myteams where id = '${req.body.id}')  OR
    id =(select player9 from myteams where id = '${req.body.id}') OR
    id =(select player10 from myteams where id = '${req.body.id}') OR
...
router.post('/get-edit-team', (req, res) => {
    ...
    p.id =(select player1 from myteams where id = '${req.body.id}') OR
    p.id =(select player2 from myteams where id = '${req.body.id}') OR
    p.id =(select player3 from myteams where id = '${req.body.id}') OR
    p.id =(select player4 from myteams where id = '${req.body.id}') OR
    p.id =(select player5 from myteams where id = '${req.body.id}') OR
    p.id =(select player6 from myteams where id = '${req.body.id}') OR
    p.id =(select player7 from myteams where id = '${req.body.id}') OR
    p.id =(select player8 from myteams where id = '${req.body.id}')  OR
    p.id =(select player9 from myteams where id = '${req.body.id}') OR
    p.id =(select player10 from myteams where id = '${req.body.id}') OR
...
router.post('/get-single-team-with-points', (req, res) => {
    ...
    p.id =(select player1 from myteams where id = '${req.body.id}' and matchid = '${req.body.matchid}')  OR
    p.id =(select player2 from myteams where id = '${req.body.id}' and matchid = '${req.body.matchid}')  OR
    p.id =(select player3 from myteams where id = '${req.body.id}' and matchid = '${req.body.matchid}')  OR
    p.id =(select player4 from myteams where id = '${req.body.id}' and matchid = '${req.body.matchid}')  OR
    p.id =(select player5 from myteams where id = '${req.body.id}' and matchid = '${req.body.matchid}')  OR
    p.id =(select player6 from myteams where id = '${req.body.id}' and matchid = '${req.body.matchid}')  OR
    p.id =(select player7 from myteams where id = '${req.body.id}' and matchid = '${req.body.matchid}')  OR
    p.id =(select player8 from myteams where id = '${req.body.id}' and matchid = '${req.body.matchid}')  OR
    p.id =(select player9 from myteams where id = '${req.body.id}' and matchid = '${req.body.matchid}')  OR
    p.id =(select player10 from myteams where id = '${req.body.id}' and matchid = '${req.body.matchid}') OR
...
router.get('/get-banner-image', (req, res) => {
    pool.query(`select * from banner_image order by id desc`, (err, result) => {
        if (err) throw err;
        else res.json(result)
    })
})
